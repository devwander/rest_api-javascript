...
module.exports = {
  ...
  // cacheDirectory: "C:\\Users\\br\\AppData\\Local\\Temp\\jest",
  ...
  // your CPU amount + 1 as the maximum worker number. maxWorkers: 2 will
  // use a maximum of 2 workers.
  // maxWorkers: "50%",
  ...
  // An array of regexp patterns that are matched against all source
  // file paths before re-running tests in watch mode
